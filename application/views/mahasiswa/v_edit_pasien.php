        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form action="<?php echo site_url('mahasiswa/update_pasien');?>" method="post">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="alamat" id="exampleFormControlTextarea1" value="<?php echo $alamat;?>" required="" rows="3"></input>
                </div>
                <br>
