...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo base_url("assets/login1/images/lab.jpg");?>');">
			<div class="wrap-login100 p-t-120 p-b-30">
				<form class="login100-form validate-form" action="<?php echo base_url().'login/auth'?>" method= "post">
					<div class="login100-form-avatar">
						<img src="<?php echo base_url().'assets/login1/images/poltek.png'?>" alt="AVATAR">
					</div>
