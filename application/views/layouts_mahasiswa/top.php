...
<head>
  ...
  <link href="<?php echo base_url().'assets/modal/css/bootstrap.css'?>" rel="stylesheet">
      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url().'mahasiswa/pasien'?>">Data Pasien</a>
            <a class="collapse-item" href="<?php echo base_url().'mahasiswa/laporan'?>">Laporan</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?php echo base_url('assets/login/images/ran.jpeg'); ?>">
              </a>
